		...
		<div className="text-gray-600 body-font">
			<div className="container flex flex-wrap px-5 pb-24 mx-auto ">
				...
				<img src={logo} className="mr-2 rounded-full" style={{width:'20%'}}/>
					<h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Welcome To Code By Rudy</h1>
					<p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Check Projects and Give Us Feedback</p>
				</div>
				...
				<div className="flex flex-wrap -m-4" style={{width:'100%', justifyContent: 'center'}} >
					...
					<div className="xl:w-1/3 md:w-1/2 p-4" style={mywidth}>
						<div className="border border-gray-200 p-6 rounded-lg">
							...
							<h2 className="text-lg text-gray-900 font-medium title-font mb-2">AI Projects</h2>
							<p className="leading-relaxed text-base">Languges / Libraries : Python , TensorFlow ,  Ray</p>
						</div>
					</div>
					<div className="xl:w-1/3 md:w-1/2 p-4" style={mywidth}>
						<div className="border border-gray-200 p-6 rounded-lg">
