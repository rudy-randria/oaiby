...
export default () => {
    ...
    <div className="container mx-auto flex px-5 pt-24 items-center justify-center flex-col">
        ...
        <div className="text-center lg:w-2/3 w-full">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-teal-600">I Am Rudy Randria</h1>
            <p className="mb-8 leading-relaxed">I Am A Full Stack Developer. Deep knowledge and proficiency in Django Framework , Backend And Responsive Web Design. Check My Projects And Give Me A Feedback.Contact Me If You Have Any Questions. Thanks For Visiting Our Site.</p>
...
<div className="p-2 w-full pt-8 mt-8  text-center">
    ...
    <span className="inline-flex">
	  <a target="blank" href="https://web.facebook.com/rud.randria/" className="text-gray-500">
	  ...
	  <a target="blank" href="https://www.linkedin.com/in/rudy-randriamampiandry-531502197/" className="ml-4 text-gray-500">
	  ...
	  <a target="blank" href="https://www.instagram.com/randriamampiandr/" className="ml-4 text-gray-500">
		<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
		  <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
		  <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
		</svg>
	  </a>  
	  <a target="blank" href="https://github.com/rudy-randria" className="ml-4 text-gray-500">
	  ...
	  <a target="blank" href="mailto:rudrandria@gmail.com" className="ml-4 text-gray-500">
